package com.example.ec.exploremsboot;

import com.example.ec.exploremsboot.domain.Difficulty;
import com.example.ec.exploremsboot.domain.Region;
import com.example.ec.exploremsboot.service.TourPackageService;
import com.example.ec.exploremsboot.service.TourService;
...
public class ExploremsbootApplication implements CommandLineRunner {

	private final TourPackageService tourPackageService;
	private final TourService tourService;

	public ExploremsbootApplication(TourPackageService tourPackageService, TourService tourService) {
		this.tourPackageService = tourPackageService;
		this.tourService = tourService;
	}

	public static void main(String[] args) {
		SpringApplication.run(ExploremsbootApplication.class, args);
	}
